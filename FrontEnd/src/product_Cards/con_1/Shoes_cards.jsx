...
const ProductView = () => {
    ...
    const totalPrice = (Number(getData.discountedPrice || 0) * quntity)  // count total price on quntity.
                        ...
                        <div className='w-full px-3 py-4 flex flex-col gap-3 border-2 border-gray-400/35 rounded'>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <div className='flex gap-4 '>
                                    <div className='border-gray-300 border-2 px-3 py-2 rounded flex justify-center items-center'>7</div>
                                    <div className='border-gray-300 border-2 px-3 py-2 rounded flex justify-center items-center'>8</div>
                                    <div className='border-gray-300 border-2 px-3 py-2 rounded flex justify-center items-center'>9</div>
                                    <div className='border-gray-300 border-2 px-3 py-2 rounded flex justify-center items-center'>10</div>
                                </div>
                            </div>
